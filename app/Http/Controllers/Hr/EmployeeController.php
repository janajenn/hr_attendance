...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'birthdate'     => 'nullable|date|before:today', // optional now
        ...
        return redirect()->route('hr.employees.index')
            ->with('success', "Employee created. Default password is: " . self::DEFAULT_PASSWORD);
    }
    ...
    public function resetPassword(User $user)
    {
        ...
        return back()->with('success', "Password reset to default: " . self::DEFAULT_PASSWORD);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($request->has('birthdate'))     $data['birthdate'] = $validated['birthdate'];
